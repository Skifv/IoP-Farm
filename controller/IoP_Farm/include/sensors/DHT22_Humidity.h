 ...
 * 
 * 2. Принцип измерения влажности:
 *    - Содержит емкостной компонент для измерения влажности с двумя электродами
 *    - Между электродами находится влагоудерживающий субстрат
 *    - При изменении влажности меняется проводимость этого субстрата
 *    - Изменение сопротивления измеряется и преобразуется во влажность
